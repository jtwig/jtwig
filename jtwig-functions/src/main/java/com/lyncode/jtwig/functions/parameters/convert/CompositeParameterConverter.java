...
public class CompositeParameterConverter implements com.lyncode.jtwig.functions.parameters.convert.api.ParameterConverter {
    private Map<Class<?>, Map<Class<?>, com.lyncode.jtwig.functions.parameters.convert.api.ParameterConverter>> converters = new HashMap<>();

    public CompositeParameterConverter() {
    ...
    public CompositeParameterConverter add(Class<?> from, Class<?> to, com.lyncode.jtwig.functions.parameters.convert.api.ParameterConverter converter) {
