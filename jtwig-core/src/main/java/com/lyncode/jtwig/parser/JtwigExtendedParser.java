...
//
//    /**
//     * Pushes a MultipleArgumentsFunction
//     *
//     * @return
//     */
//    Rule MultipleArgumentsFunction () {
//    	return Sequence(
//    			WriteIt("Entering Rule (MultipleArgumentsFunction)"),
//    			Identifier(),
//    			push(new FunctionExpr((String) pop())),
//    			Optional(LPARENT, Arguments(), RPARENT),
//    			WriteIt("Leaving Rule (MultipleArgumentsFunction)")
//    	);
//    }
//
//    /**
