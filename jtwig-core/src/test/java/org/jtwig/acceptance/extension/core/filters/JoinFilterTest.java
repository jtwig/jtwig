...
public class JoinFilterTest {
    ...
    public void generalTests() throws Exception {
        ...
        assertEquals("", JtwigTemplate.inlineTemplate("{{ obj|join }}").render(new JtwigModelMap().add("obj", new Object())));
        assertEquals("abc", JtwigTemplate.inlineTemplate("{{ 'abc'|join }}").render());
    }
