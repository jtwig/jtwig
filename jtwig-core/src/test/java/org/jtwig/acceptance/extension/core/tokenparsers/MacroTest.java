...
public class MacroTest {
    ...
    public void ensureMacrosAreAddedToTemplate() throws Exception {
        ...
        Template.Compiled compile = environment.compile(new ClasspathLoader.ClasspathResource("templates/acceptance/macro/macro.twig"));
    ...
    public void ensureLastMacroDefinedWithSameNameIsUsed() throws Exception {
        ...
        Template.Compiled compile = environment.compile(new ClasspathLoader.ClasspathResource("templates/acceptance/macro/overloading.twig"));
